...
const WaitGameStart = (params:{
  ...
  return (
    <>
      <div className="w-full h-full flex gap-4 [&>*]:bg-white dark:[&>*]:bg-dark [&>*]:rounded-xl">
            <div className="w-full md:w-full p-4 hidden md:flex md:flex-col">
              ...
              <div className='flex flex-col mt-10'>
                ...
                <h2 className="text-4xl font-extrabold dark:text-white py-1">{game.gameCode}</h2>
              </div>
              <div className='mt-auto'>
                ...
                />
                <h2 className="dark:text-white inline p-2">{game.creator.name}</h2>
              </div>
            </div>
            <div className="md:w-[45vw] w-[99vw] flex flex-col p-2 md:p-4">
              ...
              <div className='flex flex-col mt-2 md:hidden'>
                ...
                <h2 className="text-2xl font-extrabold dark:text-white">{game.gameCode}</h2>
              </div>
            </div>
      </div>
    </>
