...
const Loader = () => {
  return <>
    <div className="w-[100vw] h-[100vh] bg-lprimary dark:bg-dprimary absolute top-0 flex flex-col justify-center items-center">
      <div className='text-3xl font-bold my-4 dark:text-dark text-white'>Ready up!</div>
      <div role="status" className='text-white dark:text-dark'>
        <svg aria-hidden="true" className="w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-lprimary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='my-4 text-xl dark:text-dark text-white'>Wait for it...</div>
    </div>
