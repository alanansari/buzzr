...
const Question = (params: {
    ...
    return (
        <>
            <QuestionAndResult question={params.question} quizTitle={params.quizTitle} quesTime={params.question.timeOut} gameCode={params.gameCode} screen="question" submitAnswer={submitAnswer} optionId={optionId} />
        </>
    )
}
